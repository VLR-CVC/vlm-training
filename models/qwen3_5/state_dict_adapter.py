# Vendored from torchtitan b21f7d43e: torchtitan/models/qwen3_5/state_dict_adapter.py
...
class Qwen35StateDictAdapter:
    def __init__(self, model_config: Qwen35Model.Config, hf_assets_path: str | None = None):
        ...
        self.from_hf_map = {
            ...
            # Qwen3-VL DeepStack mergers (absent from Qwen3.5 checkpoints)
            "model.visual.deepstack_merger_list.{}.norm.weight": "vision_encoder.deepstack_mergers.{}.norm.weight",
            "model.visual.deepstack_merger_list.{}.norm.bias": "vision_encoder.deepstack_mergers.{}.norm.bias",
            "model.visual.deepstack_merger_list.{}.linear_fc1.weight": "vision_encoder.deepstack_mergers.{}.linear_fc1.weight",
            "model.visual.deepstack_merger_list.{}.linear_fc1.bias": "vision_encoder.deepstack_mergers.{}.linear_fc1.bias",
            "model.visual.deepstack_merger_list.{}.linear_fc2.weight": "vision_encoder.deepstack_mergers.{}.linear_fc2.weight",
            "model.visual.deepstack_merger_list.{}.linear_fc2.bias": "vision_encoder.deepstack_mergers.{}.linear_fc2.bias",
        }
