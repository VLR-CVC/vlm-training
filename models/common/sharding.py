# Vendored from torchtitan b21f7d43e: torchtitan/protocols/sharding.py
...
from train.parallel.parallel_dims import MeshAxisName, unfold_dp_axis
from train.parallel.spmd import _per_axis_types, spmd_axes
