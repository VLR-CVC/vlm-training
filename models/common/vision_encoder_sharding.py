# Vendored from torchtitan b21f7d43e: torchtitan/models/common/vision_encoder_sharding.py
...
from models.common.decoder_sharding import set_gqa_inner_attention_local_spmd
from models.common.sharding import ShardingConfig
from train.parallel.parallel_dims import MeshAxisName

if TYPE_CHECKING:
    from models.common.vision_encoder import VisionTransformerBlock
